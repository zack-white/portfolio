      ...
      <div className="section flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-[var(--color-text-muted)] hover:text-[var(--color-link)] transition-colors"
            aria-label="LinkedIn"
          >
        ...
        <div className="md:hidden border-t border-[var(--color-border)] bg-[var(--color-bg-elevated)]">
          <div className="section py-4 flex flex-col gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm text-[var(--color-text-muted)] hover:text-[var(--color-accent)] py-1"
            >
              Resume
            </a>
          </div>
